...
class FirestoreWrapper {
  ...
  runTransaction(updateFunction) {
    return this.firestore.runTransaction(transaction => updateFunction(new _TransactionWrapper.default(transaction)));
  }
  ...
  namedQuery(name) {
    return new _QueryWrapper.default(this.firestore.namedQuery(name));
  }

...
import type { DocumentsIn, GenericDocumentSchema, GenericFirestoreCollection, SchemaKeysOf, SchemaOfCollection } from "@firestore-schema/core";
import type { EnsureDocumentHasKey, EnsureDocumentKeyDoesNotExtendValue, EnsureValueExtendsDocumentKey, GettableDocumentSchema, GettableFirestoreDataType, GettableFirestoreDataTypeNoArray } from "./types";
/**
 ...
 * - {@link ref `ref`}
 */
declare class QueryWrapper<Collection extends GenericFirestoreCollection> implements FirebaseFirestoreTypes.Query<SchemaOfCollection<Collection>> {
    /** The raw Firebase `Query` instance. */
    ref: FirebaseFirestoreTypes.Query<SchemaOfCollection<Collection>>;
    /**
     ...
     */
    endAt(snapshot: FirebaseFirestoreTypes.DocumentSnapshot): QueryWrapper<Collection>;
    /**
     ...
     * @returns The created `QueryWrapper`.
     */
    endBefore(snapshot: FirebaseFirestoreTypes.DocumentSnapshot): QueryWrapper<Collection>;
    /**
     * Creates and returns a new `QueryWrapper` that ends before the provided
     ...
     */
    get(options?: FirebaseFirestoreTypes.GetOptions): Promise<FirebaseFirestoreTypes.QuerySnapshot<SchemaOfCollection<Collection>>>;
    /**
     ...
     * `Query`.
     */
    isEqual(other: FirebaseFirestoreTypes.Query<SchemaOfCollection<Collection>>): boolean;
    isEqual(other: QueryWrapper<GenericFirestoreCollection> | FirebaseFirestoreTypes.Query<SchemaOfCollection<Collection>>): boolean;
    /**
    ...
    onSnapshot(observer: {
        ...
        next?: (snapshot: FirebaseFirestoreTypes.QuerySnapshot<GettableDocumentSchema<DocumentsIn<Collection>>>) => void;
    }): () => void;
    /**
     * Attaches a listener for `QuerySnapshot` events.
     *
     ...
     */
    onSnapshot(onNext: (snapshot: FirebaseFirestoreTypes.QuerySnapshot<GettableDocumentSchema<DocumentsIn<Collection>>>) => void, onError?: (error: Error) => void, onCompletion?: () => void): () => void;
    /**
     * Attaches a listener for `QuerySnapshot` events.
     *
     * > Although an `onCompletion` callback can be provided, it will never be
     ...
     * @param onCompletion An optional function which will never be called.
     */
    onSnapshot(options: FirebaseFirestoreTypes.SnapshotListenOptions, onNext: (snapshot: FirebaseFirestoreTypes.QuerySnapshot<GettableDocumentSchema<DocumentsIn<Collection>>>) => void, onError?: (error: Error) => void, onCompletion?: () => void): () => void;
    /**
     ...
     * @returns The created `QueryWrapper`.
     */
    orderBy(fieldPath: string | FirebaseFirestoreTypes.FieldPath, directionStr?: "asc" | "desc"): QueryWrapper<Collection>;
    /**
     ...
     * @returns The created `QueryWrapper`.
     */
    startAfter(snapshot: FirebaseFirestoreTypes.DocumentSnapshot): QueryWrapper<Collection>;
    /**
     * Creates and returns a new `QueryWrapper` that starts after the provided
     * fields relative to the order of the query. The order of the field values
     * must match the order of the order by clauses of the query.
     ...
     * @returns The created `QueryWrapper`.
     */
    startAt(snapshot: FirebaseFirestoreTypes.DocumentSnapshot): QueryWrapper<Collection>;
    /**
     ...
     * @returns The created `QueryWrapper`.
     */
    where<FieldPathType extends SchemaKeysOf<DocumentsIn<Collection>>, InType extends GettableFirestoreDataType>(fieldPath: FieldPathType, opStr: "in", value: InType[]): EnsureValueExtendsDocumentKey<Collection, FieldPathType, InType> extends infer R ? R extends GenericFirestoreCollection ? QueryWrapper<R> : never : never;
    /**
     * Creates and returns a new `QueryWrapper` with the additional filter that
     * documents must contain the specified field and that its value should
     * satisfy the relation constraint provided.
     ...
     * @returns The created `QueryWrapper`.
     */
    where<InType extends GettableFirestoreDataType>(fieldPath: string | FirebaseFirestoreTypes.FieldPath, opStr: "in", value: InType[]): EnsureValueExtendsDocumentKey<Collection, string, InType> extends infer R ? R extends GenericFirestoreCollection ? QueryWrapper<R> : never : never;
    /**
     * Creates and returns a new `QueryWrapper` with the additional filter that
     * documents must contain the specified field and that its value should
     * satisfy the relation constraint provided.
     ...
     * @returns The created `QueryWrapper`.
     */
    where<ContainsType extends GettableFirestoreDataTypeNoArray>(fieldPath: string | FirebaseFirestoreTypes.FieldPath, opStr: "array-contains", value: ContainsType): EnsureValueExtendsDocumentKey<Collection, string, ContainsType[]> extends infer R ? R extends GenericFirestoreCollection ? QueryWrapper<R> : never : never;
    /**
     * Creates and returns a new `QueryWrapper` with the additional filter that
     * documents must contain the specified field and that its value should
     * satisfy the relation constraint provided.
     ...
     * @returns The created `QueryWrapper`.
     */
    where<CompareType extends GettableFirestoreDataType>(fieldPath: string | FirebaseFirestoreTypes.FieldPath, opStr: "==" | "<=" | ">=" | "<" | ">", value: CompareType): EnsureValueExtendsDocumentKey<Collection, string, CompareType> extends infer R ? R extends GenericFirestoreCollection ? QueryWrapper<R> : never : never;
    /**
     * Creates and returns a new `QueryWrapper` with the additional filter that
     * documents must contain the specified field and that its value should
     * satisfy the relation constraint provided.
     ...
     * @returns The created `QueryWrapper`.
     */
    where<CompareType extends GettableFirestoreDataType>(fieldPath: string | FirebaseFirestoreTypes.FieldPath, opStr: "!=", value: CompareType): EnsureDocumentKeyDoesNotExtendValue<Collection, string, CompareType> extends infer R ? R extends GenericFirestoreCollection ? QueryWrapper<R> : never : never;
    /**
     * Creates and returns a new `QueryWrapper` with the additional filter that
     * documents must contain the specified field and that its value should
     * satisfy the relation constraint provided.
     ...
     * @returns The created `QueryWrapper`.
     */
    where<FieldPathType extends SchemaKeysOf<DocumentsIn<Collection>>>(fieldPath: FieldPathType, opStr: FirebaseFirestoreTypes.WhereFilterOp, value: unknown): EnsureDocumentHasKey<Collection, FieldPathType> extends infer R ? R extends GenericFirestoreCollection ? QueryWrapper<R> : never : never;
    /**
     * Creates and returns a new `QueryWrapper` with the additional filter that
     * documents must contain the specified field and that its value should
     * satisfy the relation constraint provided.
     ...
     * @returns The created `QueryWrapper`.
     */
    where(fieldPath: string | FirebaseFirestoreTypes.FieldPath, opStr: FirebaseFirestoreTypes.WhereFilterOp, value: unknown): QueryWrapper<Collection>;
}

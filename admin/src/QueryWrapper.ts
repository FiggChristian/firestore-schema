 ...
 * possible keys.
 */
type NestedDocumentKeys<Collection extends GenericFirestoreCollection> =
  Collection extends {
    ...
    ? {
        [DocumentName in DocumentNames]: Collection[DocumentName] extends {
          ...
          ? Schema extends object
            ? string extends StrKeyof<Schema>
              ? never
              : StrKeyof<Schema>
            : never
          : never;
          ...
          [SpecificDocumentName in AllDocumentNames]: SpecificDocumentName extends string
            ? Collection[SpecificDocumentName] extends GenericFirestoreDocument
              ? Key extends StrKeyof<
                  Collection[SpecificDocumentName][DOCUMENT_SCHEMA]
                >
          ...
          [SpecificDocumentName in AllDocumentNames]: SpecificDocumentName extends string
            ? Collection[SpecificDocumentName] extends GenericFirestoreDocument
              ? Key extends StrKeyof<
                  Collection[SpecificDocumentName][DOCUMENT_SCHEMA]
                >
                ? Collection[SpecificDocumentName][DOCUMENT_SCHEMA][Key] extends Extends
                  ? never
                  : SpecificDocumentName
                : never
              : never
          ...
          [SpecificDocumentName in AllDocumentNames]: SpecificDocumentName extends string
            ? Collection[SpecificDocumentName] extends GenericFirestoreDocument
              ? Key extends StrKeyof<
                  Collection[SpecificDocumentName][DOCUMENT_SCHEMA]
                >
                ? Extends extends Collection[SpecificDocumentName][DOCUMENT_SCHEMA][Key]
                  ? SpecificDocumentName
                  : never
                : never
              : never
...
class QueryWrapper<Collection extends GenericFirestoreCollection> {
   ...
   */
  where<
    FieldPathType extends NestedDocumentKeys<Collection>,
   ...
   * @return The created `QueryWrapper`.
   */
  where<FieldPathType extends NestedDocumentKeys<Collection>>(
    fieldPath: FieldPathType,
   ...
   * @return The created `QueryWrapper`.
   */
  select<Fields extends NestedDocumentKeys<Collection>>(
    ...field: Fields[]
  ): QueryWrapper<DocumentData>; // TODO: Narrow type
  /**
   * Creates and returns a new `QueryWrapper` instance that applies a field mask
   * to the result and returns only the specified subset of fields. You can
   * specify a list of field paths to return, or use an empty list to only
  ...
  ): QueryWrapper<DocumentData> | QueryWrapper<GenericFirestoreCollection> {

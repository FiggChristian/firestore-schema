 ...
 * - {@link ref `ref`}
 */
class WriteBatchWrapper implements FirebaseFirestore.WriteBatch {
  /** The raw Firebase `WriteBatch` instance. */
  public ref: FirebaseFirestore.WriteBatch;
  ...
  // `create` method in `FirebaseFirestore.WriteBatch`, but copying and pasting

import type { DefaultIfNever, DocumentsIn, GenericDocumentSchema, GenericFirestoreCollection, GenericFirestoreDocument, SchemaKeysOf, SchemaOfCollection, SchemaOfDocument } from "@firestore-schema/core";
 ...
 * - {@link ref `ref`}
 */
export declare class ReadOnlyTransactionWrapper implements Omit<FirebaseFirestore.Transaction, "create" | "set" | "update" | "delete"> {
    /** The raw Firebase `Transaction` instance. */
    ref: FirebaseFirestore.Transaction;
    /**
     ...
     */
    get<Collection extends GenericFirestoreCollection, ConvertedType>(query: QueryWrapper<Collection, ConvertedType> | FirebaseFirestore.Query<DefaultIfNever<ConvertedType, SchemaOfCollection<Collection>>>): Promise<FirebaseFirestore.QuerySnapshot<DefaultIfNever<ConvertedType, GettableDocumentSchema<DocumentsIn<Collection>>>>>;
    /**
     ...
     */
    get<Document extends GenericFirestoreDocument, ConvertedType>(documentRef: DocumentWrapper<Document, ConvertedType> | FirebaseFirestore.DocumentReference<DefaultIfNever<ConvertedType, SchemaOfDocument<Document>>>): Promise<FirebaseFirestore.DocumentSnapshot<DefaultIfNever<ConvertedType, GettableDocumentSchema<Document>>>>;
    /**
 ...
 * - {@link ref `ref`}
 */
export declare class ReadWriteTransactionWrapper extends ReadOnlyTransactionWrapper implements FirebaseFirestore.Transaction {
    /**

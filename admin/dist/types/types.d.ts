...
import type { ConvertDocumentSchemaType, Expand, GenericDocumentSchema, GenericFirestoreCollection, GenericFirestoreDocument, SchemaOfDocument, StrKeyof } from "@firestore-schema/core";
 ...
 */
export type GettableFirestoreDataTypeNoArray = string | number | boolean | null | FirebaseFirestore.Timestamp | Buffer | FirebaseFirestore.GeoPoint | FirebaseFirestore.DocumentReference | {
 ...
 * Arrays since Arrays are only allowed to be one-dimensional.
 */
export type SettableFirestoreDataTypeNoArray = GettableFirestoreDataType | Date | Uint8Array | {
 ...
 */
export type GettableDocumentSchema<Document extends GenericFirestoreDocument> = Expand<ConvertDocumentSchemaType<ConvertDocumentSchemaType<SchemaOfDocument<Document>, Date, FirebaseFirestore.Timestamp>, Uint8Array, Buffer>>;
/**
 ...
 */
export type SettableDocumentSchema<Document extends GenericFirestoreDocument> = Expand<ConvertDocumentSchemaType<ConvertDocumentSchemaType<SchemaOfDocument<Document>, Date | FirebaseFirestore.Timestamp, Date | FirebaseFirestore.Timestamp>, Uint8Array | Buffer, Uint8Array | Buffer>>;
/**
 ...
 */
export interface TypedFirestoreDataConverter<DocumentSchema extends GenericDocumentSchema, ConvertedType> {
    /**
     ...
     */
    toFirestore(modelObject: FirebaseFirestore.WithFieldValue<ConvertedType>): DocumentSchema;
    /**
     * Called by the Firestore SDK to convert a custom model object of type T
     * into a plain Javascript object (suitable for writing directly to the
     * Firestore database). To use set() with `merge` and `mergeFields`,
     ...
     * omitted.
     */
    toFirestore(modelObject: FirebaseFirestore.PartialWithFieldValue<ConvertedType>, options: FirebaseFirestore.SetOptions): DocumentSchema;
    /**
     * Called by the Firestore SDK to convert Firestore data into an object of
     * type T.
     */
    fromFirestore(snapshot: FirebaseFirestore.QueryDocumentSnapshot<DocumentSchema>): ConvertedType;
}
/**

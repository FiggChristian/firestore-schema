 ...
 */
type IndexAllCollectionsInDocument<Document extends Pick<GenericFirestoreDocument, string>, Rest extends string> = Document extends Pick<GenericFirestoreDocument, string> ? {
 ...
 */
type IndexAllDocumentsInCollection<Collection extends GenericFirestoreCollection, Rest extends string> = Collection extends GenericFirestoreCollection ? {
 ...
 */
type NestedIndexByCollectionGroupID<CollectionName extends string, Document extends Pick<GenericFirestoreDocument, string>> = Document extends Pick<GenericFirestoreDocument, string> ? {
    [NestedCollectionName in StrKeyof<Document>]: (CollectionName extends NestedCollectionName ? Document[NestedCollectionName] : never) | {
 ...
 */
export type ConvertDocumentSchemaType<DocumentSchema extends GenericDocumentSchema, From, To> = DocumentSchema extends GenericDocumentSchema ? {
 ...
 */
type ConvertDocumentSchemaValueType<Value, From, To> = Value extends (infer T)[] ? number extends Value["length"] ? ConvertDocumentSchemaValueType<T, From, To>[] : {
